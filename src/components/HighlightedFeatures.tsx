      ...
      <div className="relative">
        <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
          <div className="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0">
            <div>
              <div>
                <FadeInUpWhenVisible delay={animationTimeSpacer(6)}>
              ...
              <div className="mt-6">
                <FadeInUpWhenVisible delay={animationTimeSpacer(7)}>
                  <h2 className="text-3xl font-bold tracking-tight text-gray-900">
                    Gestão empresarial eficiente
                  </h2>
                </FadeInUpWhenVisible>
                <FadeInUpWhenVisible delay={animationTimeSpacer(8)}>
                  <p className="mt-4 text-lg text-gray-500">
                    Nossa plataforma fácil de usar permite que você gerencie
                    todos os aspectos do seu negócio em um só lugar,
                    simplificando suas operações e economizando seu tempo.
                  </p>
                </FadeInUpWhenVisible>
                <div className="mt-6">
                  <FadeInUpWhenVisible delay={animationTimeSpacer(9)}>
                    <Link
                      href="/"
                      anchor="client-app"
            ...
            <FadeInUpWhenVisible delay={animationTimeSpacer(12)}>
            ...
            <div>
              ...
              <div className="mt-6">
                ...
                <FadeInUpWhenVisible delay={animationTimeSpacer(3)}>
                  <p className="mt-4 text-lg text-gray-500">
                    Nosso aplicativo coloca o poder do seu negócio nas palmas
                    das mãos de seus clientes, permitindo que eles marquem
                    facilmente compromissos, visualizem serviços e preços e
                    muito mais.
                  </p>
                </FadeInUpWhenVisible>
                <div className="mt-6">
