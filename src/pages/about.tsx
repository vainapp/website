                      ...
                      <div className="rounded-t-lg px-6 py-8 sm:px-10 sm:pt-10 sm:pb-8">
                        ...
                        <div className="relative mt-8 text-lg font-medium text-gray-700">
                          ...
                          <p className="relative">
                            Um dos principais problemas de salões que impedem
                            seus crescimentos é a maneira de se organizar, seja
                            num papel ou em algum aplicativo de anotações. A
                            Vain veio pra atacar esse problema.
                          </p>
                        </div>
                      </div>
              ...
              <div className="pt-12 sm:pt-16 lg:pt-20">
                ...
                <div className="prose prose-lg prose-orange mx-auto mt-6 text-gray-500">
                  <p className="text-base leading-7">
                    Em uma conversa entre amigos, nós abordamos como a
                    tecnologia tornou diversos serviços mais acessíveis e
                    eficientes. Notamos que não havia nada parecido no mundo da
                    estética. A partir daí, começamos a pensar em como
                    poderíamos aplicar essas ideias no mundo da beleza.
                  </p>
                  <p className="text-base leading-7">
                    Conversamos com especialistas da area e buscamos entender a
                    necessidade. Notamos pontos importantes, como a dificuldade
                    de se ter um controle de agenda, de clientes e de
                    financeiro. A partir daí, começamos a desenvolver uma
                    solução que pudesse resolver esses problemas.
                  </p>
                </div>
              </div>
              <div className="mt-10">
