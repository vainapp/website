...
export default function EmployeeEmailVerified(): JSX.Element | null {
  ...
  useEffect(() => {
    if (needsSMSVerification === 'false') {
      void router.push({
        pathname: '/employee/phone-number-verified',
        query: {
          employee_id: employeeId,
        },
      })
    }
  }, [employeeId, needsSMSVerification, router])

  if (employeeId == null || needsSMSVerification == null) {
    return null
  }
  ...
  return (
    <>
      <NextSeo title="E-mail verificado" noindex />
      ...
      <SignUpFlowWrapper>
        <>
          ...
          <p className="mt-4 text-lg text-gray-500 sm:mt-3">
            Informe o código que enviamos por SMS para o seu número de telefone.
          </p>
          <form
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-1">
                <input
                  ...
                  placeholder='Ex.: "1234"'
                  {...form.register('code')}
                  aria-invalid={form.formState.errors.code?.message != null}
                  aria-describedby={
